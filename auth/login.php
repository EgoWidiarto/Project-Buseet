...
<html lang="en">
  ...
  <body class="d-flex justify-content-center">
    ...
    <div class="container">
      ...
      <form action="../config/login-validate.php" method="post" class="text-center login-input">
        <!-- Email Input -->
        ...
        <!-- Google And Facebook Login Icon Start -->
        <div class="row m-auto text-center login-way mb-3">
          <div class="col">
            <a href="">
              <img src="../assets/icon/facebook.svg" width="50px" alt="Logo Facebook" />
            </a>
          </div>
          <div class="col">
            <a href="">
              <img src="../assets/icon/google.svg" width="50px" alt="Logo Google" />
            </a>
          </div>
        </div>
        <!-- Google And Facebook Login Icon End -->
        <p>Don’t have an account? <a href="register.php" class="text-white fw-bold ms-1">Sign up</a></p>
      </form>
    </div>
    <!-- Main Content End -->
    <!-- Bootstrap Script -->
